...
export function LandingNavbar({data} : {data : any}){
    ...
    return (
        <div className="bg-black/30 z-50 text-white fixed top-0 left-0 right-0 h-15 backdrop-blur-md px-20 flex flex-row justify-between items-center lg:px-50">
                ...
                <div className="flex flex-row items-center gap-x-2">
                    <div >
                        <img src={Logo} className="h-10 hover:cursor-pointer"></img>

                    </div>
                    <div className="text-base font-medium stroke-current tracking-wider">
                        STATIFY
                    </div>
                </div>
                
                <div className="flex items-center gap-6">
                    <div className="hidden transition-all duration-700 lg:block text-neutral-400 hover:text-neutral-50 cursor-pointer underline-offset-2">
                        Features
                    </div>
                    <div className="hidden transition-all duration-700 lg:block text-neutral-400 hover:text-neutral-50 cursor-pointer underline-offset-2">
                        Privacy
